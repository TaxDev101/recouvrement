...
import darkMode from "../../assets/img/generic//falcon-mode-dark.jpg";
import lightMode from "../../assets/img/generic/falcon-mode-default.jpg";
import arrowh from "../../assets/img/icons/arrows-h.svg";
import navdefault from "../../assets/img/generic/default.png";
import inverted from "../../assets/img/generic/inverted.png";
    ...
    <>
        ...
        <div className="offcanvas-header settings-panel-header bg-shape">
          <div className="z-index-1 py-1 light">
            <h5 className="text-white">
              <span className="fas fa-palette me-2 fs-0"></span>Paramètres
            </h5>
            ...
            <div className="row gx-2">
              <div className="col-6">
                ...
                >
                  ...
                  <span className="label-text">Lumière</span>
                </label>
              </div>
              <div className="col-6">
                <input
          ...
          <div className="btn-group d-block w-100 btn-group-navbar-style">
            <div className="row gx-2">
              ...
              <div className="col-6">
                ...
                >
                  <img className="img-fluid img-prototype" src={card} alt="" />
      ...
      >
        <div className="card-body d-flex align-items-center py-md-2 px-2 py-1">
          ...
          <small className="text-uppercase text-secondary fw-bold bg-soft-primary py-2 pe-2 ps-1 rounded-end">
            PERSONNALISER
          </small>
        </div>
      </a>
